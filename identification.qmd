...
·       [Chapter 4: Searching for and selecting studies](https://training.cochrane.org/handbook/current/chapter-04), in the *Cochrane Handbook for Systematic Reviews of Interventions*.

·       [Cochrane Library User Guide](https://www.wiley.com/en-us/customer-success/cochrane/cochrane-library-user-guide)

·       [PubMed® Online Training](https://learn.nlm.nih.gov/documentation/training-packets/T0042010P/)

·       [Video Tutorials](https://hslmcmaster.libguides.com/tutorials) of searching the commonly used databases
...
·       Rephrasing search terms where relevant (e.g., by using [truncation and wildcards](https://hslmcmaster.libguides.com/srm/truncation).

·       Using pre-defined search filters where available. In this context, a search filter is a pre-defined combination of search terms and is often validated by experts. [ISSG Search Filters Resource](https://sites.google.com/a/york.ac.uk/issg-search-filters-resource/home) is a collection of established search filters on various topics.
...
·       [Epistemonikos](https://www.epistemonikos.org/en/), a database of systematic reviews in health and care fields.

·       Resources other than databases, including evidence submitted by stakeholders, or the manufacturers of an intervention. We often consider [NICE guidance](https://www.nice.org.uk/guidance) as a valuable source of information and search for relevant guidance where applicable.
