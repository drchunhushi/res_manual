...
**Clear summaries with user-friendly language and formatting:** We always provide a summary of the evidence for each key question(s), even when little or no (useful) evidence is identified (@nte-5). Each question is addressed separately. Where possible, we summarise existing evidence as a narrative synthesis as detailed in the previous Section with an assessment of certainty and relevance.
