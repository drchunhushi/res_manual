...
The section below outlines key guidance on how to construct a search strategy and presents strategy we used to identify research for the [ARC-GM RES Restricting advertising in public spaces](files/ARC-GM%20RES%20outdoor%20advertising%20harmful%20commodities.pdf) as an example.
...
For a RES, study selection is often performed by a single reviewer for speed, although consultation with a second reviewer is often undertaken. We often use the online tool [Rayyan](https://www.rayyan.ai/) to facilitate the study selection process.
