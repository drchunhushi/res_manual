...
The above example synthesis, along with its related GRADE assessment results and the judgement on the relevance of the evidence to the regional context, results in the summary in @fig-5.
...
A RES can present a brief summary of the evidence, like the ‘abstract’ of a systematic review, even when little or no (useful) evidence is identified. Where there are [**multiple RES questions**]{.underline}, the summary can be at a high level, addressing all RES questions in a more concise format. See the example below.
